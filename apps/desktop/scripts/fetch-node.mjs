...
// Idempotent: skip if the same version+arch is already bundled. Built per-platform on a native runner (macOS / Linux).
...
const ARCH = `${process.platform}-${process.arch}`; // darwin-arm64 | linux-x64 | …
