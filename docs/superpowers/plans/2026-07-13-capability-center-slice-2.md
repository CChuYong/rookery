...
- [x] **Step 1: Write failing contract and manifest tests**
...
- [x] **Step 4: Implement bounded validation and digesting**
...
- [x] **Step 5: Run manifest tests and root typecheck**
...
- [x] **Step 2: Run persistence tests and confirm schema/API failures**
...
- [x] **Step 3: Append the four-table migration**
...
- [x] **Step 4: Implement repository row mapping and CRUD**
...
- [x] **Step 5: Add deletion cleanup at existing ownership boundaries**
...
- [x] **Step 6: Run persistence tests and root typecheck**
...
- [x] **Step 3: Run focused tests and verify missing-module failures**
...
- [x] **Step 4: Implement canonical repository matching**
...
- [x] **Step 5: Implement `CapabilityRegistry`**
...
- [x] **Step 6: Implement `CapabilityResolver`**
...
- [x] **Step 7: Run focused tests, placeholder scan, and typecheck**
...
- [x] **Step 8: Commit registry and resolver**
...
- [x] **Step 1: Write failing service tests for authoritative desired resolution**
...
- [x] **Step 2: Write failing protocol and connection route tests**
...
- [x] **Step 3: Add wire result types**
...
- [x] **Step 4: Extend the service facade**
...
- [x] **Step 5: Wire registry events and routes at the daemon boundary**
...
- [x] **Step 6: Run focused backend tests and root gates**
...
- [x] **Step 1: Write failing shell/Effective tests**
...
- [x] **Step 2: Write failing Library tests**
...
- [x] **Step 3: Write failing Assignments tests**
...
- [x] **Step 4: Split the page and add a typed desktop facade**
...
- [x] **Step 5: Implement Library trust and write-only secret UX**
...
- [x] **Step 6: Implement Assignments CRUD and tombstones**
...
- [x] **Step 7: Consume generation events and complete i18n**
...
- [x] **Step 8: Run desktop tests/typecheck/build**
...
- [x] **Step 9: Commit desktop workflows**
...
- [x] **Step 1: Add and validate the example pack**
...
- [x] **Step 2: Update evergreen documentation**
...
- [x] **Step 3: Run final static and automated gates**
...
- [x] **Step 4: Run an isolated live daemon protocol smoke**
...
- [x] **Step 5: Run an Electron smoke**
...
- [x] **Step 6: Audit every exit criterion with direct evidence**
...
- [x] **Step 7: Commit docs and final tested fixes**
