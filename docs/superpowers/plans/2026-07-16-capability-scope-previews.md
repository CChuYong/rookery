...
- `package.json`, `README.md`, `AGENTS.md`, `docs/protocol.md`, and capability design docs: commands, contracts, and completed-slice status.
...
- [ ] **Step 1: Write failing core tests for Rookery preview safety**
...
- [ ] **Step 2: Write failing core tests for authoritative repository preview**
...
- [ ] **Step 4: Add the live/preview target types and snapshot contract**
...
- [ ] **Step 5: Implement preview resolution and projection**
...
- [ ] **Step 6: Run focused core tests and typecheck**
...
- [ ] **Step 2: Write failing connection tests for correlated preview responses/errors**
...
- [ ] **Step 3: Run protocol and connection tests to verify failure**
...
- [ ] **Step 4: Implement exact strict target schemas**
...
- [ ] **Step 5: Restrict daemon environment lookup to live targets**
...
- [ ] **Step 1: Write failing pure-state tests for both scopes and inheritance**
...
- [ ] **Step 2: Write failing component tests for Rookery mutation and repo inheritance copy**
...
- [ ] **Step 3: Run the state/component tests to verify failure**
...
- [ ] **Step 4: Implement the shared state projection**
...
- [ ] **Step 5: Extract the common Catalog-backed scope editor**
...
- [ ] **Step 6: Wrap the shared editor for Repository Settings**
...
- [ ] **Step 7: Add Rookery Capabilities to Settings**
...
- [ ] **Step 8: Add complete Korean and English copy**
...
- [ ] **Step 9: Run renderer tests, catalog parity, and typecheck**
...
- [ ] **Step 10: Commit the shared settings surface**
...
- [ ] **Step 1: Write failing helper tests for stable target identity and defaults**
...
- [ ] **Step 2: Write failing page tests for all target classes and preview hints**
...
- [ ] **Step 3: Write failing navigation tests for settings deep links**
...
- [ ] **Step 4: Run focused renderer tests to verify failure**
...
- [ ] **Step 5: Implement target helpers and local selector state**
...
- [ ] **Step 6: Render accurate preview metadata**
...
- [ ] **Step 7: Wire App-local preview deep links**
...
- [ ] **Step 8: Add matching selector and preview copy to both catalogs**
...
- [ ] **Step 9: Run the renderer tests and desktop build**
...
- [ ] **Step 10: Commit Effective navigation**
...
- [ ] **Step 1: Write the isolated daemon smoke script**
...
- [ ] **Step 2: Add and run the Slice 9 smoke command**
...
- [ ] **Step 5: Perform an isolated Electron visual smoke**
...
- [ ] **Step 6: Record verification and commit docs/smoke**
